...
class TestTrackedSetIndex(unittest.TestCase):
    ...
    def test_get_item(self):
        starts = ['chr1', 500]
        stops = ['chr1', 1500]
        self.assertEqual(['chr1', Interval(500, 1500)], get_item(starts, stops))

    def test_get_start_stop(self):
        track = Track(2)
        start, stop = track.get_start_stop(['chr1', Interval(500, 1500)])
        self.assertEqual(['chr1', 500], start)
        self.assertEqual(['chr1', 1500], stop)
    ...
    def test_get_overlapping_bounds(self):
        ...
        self.assertEqual((0, 0), track.get_overlapping_bounds(['chr1', 0], ['chr1', 0]))
        self.assertEqual((0, 0), track.get_overlapping_bounds(['chr1', 0], ['chr1', 1000]))
        self.assertEqual((0, 1), track.get_overlapping_bounds(['chr1', 0], ['chr1', 1001]))
        self.assertEqual((0, 1), track.get_overlapping_bounds(['chr1', 0], ['chr1', 3000]))
        self.assertEqual((0, 2), track.get_overlapping_bounds(['chr1', 0], ['chr1', 3001]))
        self.assertEqual((0, 2), track.get_overlapping_bounds(['chr1', 0], ['chr1', 4001]))
        self.assertEqual((0, 2), track.get_overlapping_bounds(['chr1', 0], ['chr2', 0]))
        self.assertEqual((0, 2), track.get_overlapping_bounds(['chr1', 0], ['chr2', 1000]))
        self.assertEqual((0, 3), track.get_overlapping_bounds(['chr1', 0], ['chr2', 1001]))
        self.assertEqual((0, 3), track.get_overlapping_bounds(['chr1', 0], ['chr2', 3000]))
        self.assertEqual((0, 4), track.get_overlapping_bounds(['chr1', 0], ['chr2', 3001]))
        self.assertEqual((0, 4), track.get_overlapping_bounds(['chr1', 0], ['chr2', 4001]))
        self.assertEqual((0, 4), track.get_overlapping_bounds(['chr1', 1999], ['chr2', 4001]))
        self.assertEqual((1, 4), track.get_overlapping_bounds(['chr1', 2000], ['chr2', 4001]))
        self.assertEqual((1, 4), track.get_overlapping_bounds(['chr1', 3999], ['chr2', 4001]))
        self.assertEqual((2, 4), track.get_overlapping_bounds(['chr1', 4000], ['chr2', 4001]))
        self.assertEqual((2, 4), track.get_overlapping_bounds(['chr2', 0], ['chr2', 4001]))
        self.assertEqual((2, 4), track.get_overlapping_bounds(['chr2', 1999], ['chr2', 4001]))
        self.assertEqual((3, 4), track.get_overlapping_bounds(['chr2', 2000], ['chr2', 4001]))
        self.assertEqual((3, 4), track.get_overlapping_bounds(['chr2', 3999], ['chr2', 4001]))
        self.assertEqual((4, 4), track.get_overlapping_bounds(['chr2', 4000], ['chr2', 4001]))
    ...
    def test_fetch(self):
        ...
        self.assertEqual([['chr1', Interval(1500, 2000)], ['chr1', Interval(3000, 3500)]],
    ...
    def test_get_cost_increase(self):
        track = Track(2)
        self.assertEqual(2, track.get_cost_increase(['chr1', Interval(0, 1000)]))
...
class TestTrackAdd(unittest.TestCase):
    ...
    def test_add_before(self):
        ...
        self.assertEqual([['chr1', 0], ['chr1', 1000], ['chr1', 3000], ['chr2', 1000], ['chr2', 3000]], self.track.starts)
        self.assertEqual([['chr1', 1000], ['chr1', 2000], ['chr1', 4000], ['chr2', 2000], ['chr2', 4000]], self.track.stops)
        self.assertEqual(['chr1', Interval(0, 1000)], self.track.items[0][0])

    def test_add_overlap(self):
        self.track.add(['chr1', Interval(0, 1001)])

        self.assertEqual([['chr1', 0], ['chr1', 3000], ['chr2', 1000], ['chr2', 3000]], self.track.starts)
        self.assertEqual([['chr1', 2000], ['chr1', 4000], ['chr2', 2000], ['chr2', 4000]], self.track.stops)
    ...
    def test_add_overlap_multiple_deep(self):
        ...
        self.assertEqual([['chr1', 1000], ['chr2', 1000], ['chr2', 3000]], self.track.starts)
        self.assertEqual([['chr1', 4000], ['chr2', 2000], ['chr2', 4000]], self.track.stops)
    ...
    def test_add_overlap_multiple_shallow(self):
        ...
        self.assertEqual([['chr1', 0]], self.track.starts)
        self.assertEqual([['chr3', 5000]], self.track.stops)
        self.assertEqual([Interval('chr1', 'chr3'), Interval(0, 5000)], self.track.items[0][-1])

    def test_get_cost_increase(self):
        self.assertAlmostEqual(0.3219281, self.track.get_cost_increase(['chr1', Interval(0, 1000)]))
        self.assertAlmostEqual(1, self.track.get_cost_increase(['chr1', Interval(0, 1001)]))
        self.assertAlmostEqual(3.5849625, self.track.get_cost_increase(['chr1', Interval(1999, 3001)]))
        self.assertAlmostEqual(8, self.track.get_cost_increase([Interval('chr1', 'chr3'), Interval(0, 5000)]))
